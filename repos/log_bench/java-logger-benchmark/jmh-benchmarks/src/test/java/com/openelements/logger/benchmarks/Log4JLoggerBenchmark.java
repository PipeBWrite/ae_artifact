...
public class Log4JLoggerBenchmark {
    ...
    public void init() throws Exception {
        ...
        Files.deleteIfExists(Path.of(LOG_DIR, "log4j-benchmark.log"));
        Files.deleteIfExists(Path.of(LOG_DIR, "log4j-async-benchmark.log"));
    ...
    private static AppenderComponentBuilder createFileAppender(final String name,
        ...
        return builder.newAppender(name, "File")
                .addAttribute("fileName", LOG_DIR + "/log4j-benchmark.log")
                .addAttribute("append", false)
                .add(layoutBuilder)
		.addAttribute("immediateFlush",
			Boolean.getBoolean("log4j.bench.immediateFlush"));
    }
    ...
    private static AppenderComponentBuilder createAsyncFileAppender(final String name,
        ...
        return builder.newAppender("file", "RandomAccessFile")
                .addAttribute("fileName", LOG_DIR + "/log4j-async-benchmark.log")
                .addAttribute("append", false)
                .add(layoutBuilder)
