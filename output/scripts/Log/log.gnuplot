...
set output '../../figures/Log/log_formal.pdf'
...
set label 1 "17.4K" at -0.17, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 2 "174.1K" at 0.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"

plot '../../raw_data/Log/log_ext4.dat' using 3:xtic(1) title "ext4" fc rgb "black" fs transparent pattern 1 lc rgb "black" lw 2, \
     '' using 4 title "SC" fc rgb "black" fs transparent pattern 4 lc rgb "black" lw 2, \
...
set label 1 "18.7K" at -0.17, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 2 "180.6K" at 0.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"

plot '../../raw_data/Log/log_xfs.dat' using 3:xtic(1) title "XFS" fc rgb "black" fs transparent pattern 1 lc rgb "black" lw 2, \
     '' using 4 title "SC" fc rgb "black" fs transparent pattern 4 lc rgb "black" lw 2, \
     '' using 5 title "PBW" fc rgb "black" fs transparent pattern 7 lc rgb "black" lw 2
