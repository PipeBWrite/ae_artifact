...
set output '../../figures/RocksDB/formal_1_throughput.pdf'
...
set ylabel "Normalized Throughput" offset 1.5,0
set title "ext4" offset 0,-12.3
set label 1 "170.73K" at -0.17, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 2 "276.23K" at 0.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 3 "165.17K" at 1.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"

unset key

plot '../../raw_data/RocksDB/formal_1_throughput_ext4.dat' using 3:xtic(1) title "BW" fc rgb "black" fs transparent pattern 1 lc rgb "black" lw 2, \
...
set label 1 "169.02K" at -0.17, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 2 "334.23K" at 0.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"
set label 3 "165.17K" at 1.83, 1.0 center offset -0.65, char 0.7 font "Helvetica,17" tc rgb "black"

plot '../../raw_data/RocksDB/formal_1_throughput_xfs.dat' using 3:xtic(1) title "BW" fc rgb "black" fs transparent pattern 1 lc rgb "black" lw 2, \
'' using 4 title "StreamCache" fc rgb "black" fs transparent pattern 4 lc rgb "black" lw 2, \
'' using 5 title "PBW" fc rgb "black" fs transparent pattern 7 lc rgb "black" lw 2
